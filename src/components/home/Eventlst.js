        ...
        <div key={index} style={{ gap: "30px", display: "flex", justifyContent: "center" }}>
          <Card style={{ width: "100%", minWidth: "310px", border: "0.5px solid rgb(229 229 229)", borderRadius: "10px" }}>
            ...
            width: "311px"
              ...
              >
              <small className="" style={{color:"white",paddingRight:"24px",paddingTop:'5px',textAlign:'end',color:"#ff3366",fontWeight:'600'}}>{calculateAgeAndBirthdayText(event.date)}</small>
              </Card>
            </div>
            <Card.Body>
