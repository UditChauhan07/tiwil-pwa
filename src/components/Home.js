...
<div>
      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList onChange={handleChange} aria-label=" " style={{backgroundColor:"#FFEFF3",border:'1px solid #ff3366',borderRadius:'40px',display:"flex",justifyContent:'space-between'}}>
