...
function App() {
  ...
  // User is not using the PWA in standalone mode (i.e., not added to Home Screen)
  // Show your custom "Add to Home Screen" prompt
  const promptElement = document.createElement('div');
  promptElement.innerHTML = `
    <div style="position: fixed; bottom: 0; left: 0; right: 0; background: #333; color: white; padding: 10px; text-align: center; z-index: 1000;">
      <p>Install this app on your iPhone: <strong>Tap the share icon and select "Add to Home Screen".</strong></p>
